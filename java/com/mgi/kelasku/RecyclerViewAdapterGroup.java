...
public class RecyclerViewAdapterGroup extends RecyclerView.Adapter<RecyclerViewAdapterGroup.DataObjectHolder>{
    private static String LOG_TAG="MyRecyclerViewAdapter";
    ArrayList<DataObjectGroup> dataSet;


    public RecyclerViewAdapterGroup(ArrayList<DataObjectGroup> dataSet){
    ...
    public void AddItem(DataObjectGroup obj, int index){
